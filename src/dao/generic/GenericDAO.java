...
public abstract class GenericDAO<T extends Persistente, E extends Serializable> implements IGenericDAO<T,E> {
    ...
    protected abstract void setParametrosQueryInsercao(PreparedStatement stmInsert, T entidade) throws SQLException;

    protected abstract void setParametrosQueryExclusao(PreparedStatement stmDelete, E chave) throws SQLException;

    protected abstract void setParametrosQueryAtualizacao(PreparedStatement stmUpdate, T entidade) throws SQLException;

    protected abstract void setParametrosQuerySelect(PreparedStatement stmUpdate, E chave) throws SQLException;
        ...
        for (Field field : fields) {
            if (field.isAnnotationPresent(TipoChave.class)) {
                ...
                try {
                    ...
                    e.printStackTrace();
                    throw new Exception("Chave principal do objeto " + entity.getClass() + " não encontrada", e);
                }
            }
        }
        if (returnValue == null) {
    ...
    public void alterar(T entity) throws Exception {
        ...
        try {
            ...
            throw new Exception("ERRO ALTERANDO OBJETO ", e);
        } finally {
            closeConnection(connection, stm, null);
        }
    }
